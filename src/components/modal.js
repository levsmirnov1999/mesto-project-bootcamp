...
const popupCloseButtonEditProfile = document.querySelector(
  ".popup__close-icon_place_edit-profile"
);
const addButton = document.querySelector(".profile__add-button");
const popupAddItem = document.querySelector(".popup_add-item");
const popupCloseButtonAddItem = document.querySelector(
  ".popup__close-icon_place_add-item"
);
const popupImage = document.querySelector(".popup_image");
const popupCloseButtonImage = document.querySelector(
  ".popup__close-icon_place_image"
);
...
const saveButton = document.querySelector(
  ".popup__save-button_place_edit-profile"
);
...
const popupCloseButtonEditAvatar = document.querySelector(
  ".popup__close-icon_place_edit-avatar"
);
...
const saveButtonAvatar = document.querySelector(
  ".popup__save-button_place_edit-avatar"
);
